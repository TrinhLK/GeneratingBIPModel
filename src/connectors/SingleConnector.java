...
public class SingleConnector {
	...
	private String name;
	private SingleConnector absName;
	...
	public SingleConnector() {
		// TODO Auto-generated constructor stub
		listElements = new ArrayList<Element>();
		listCompound = new ArrayList<Compound>();
	}
	
	public SingleConnector(ArrayList<Element> _listElements) {
		// TODO Auto-generated constructor stub
...
//		System.out.println("---Connector---Details----");
		rs += "\t\tconnector " + absName.getName() + " " + name + "_detail(";
...
//		System.out.println("---Connector---");
	...
	public SingleConnector getAbsName() {
		return absName;
	}

	public void setAbsName(SingleConnector absName) {
	...
	public void print() {
		System.out.println("----Printing Connector: " + name);
