...
//		System.out.println(sp.length);
	...
	public void print() {
		if (kind == 0) {
			System.out.println(instanceName + "_" + action + "\t" + level + "\t trigger \t" + location + "\tparent:" + parent);
		} else if (kind == 1) {
			System.out.println(instanceName + "_" + action + "\t" + level + "\t synchronize \t" + location + "\tparent:" + parent);
		} else {
			System.out.println(instanceName + "_" + action + "\t" + level + "\t in block of triggers \t" + location + "\tparent:" + parent);
		}
	...
	public void setListStates(ArrayList<String> listStates) {
